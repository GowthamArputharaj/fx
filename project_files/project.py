...
def getAllPositions():
	...
	for symbol in symbols:
		...
		for pos in list(open_positions_tuple):
			open_positions_ticket.append(list(pos))
		...
		if open_positions_tuple==None:
			...
			# cprint(df, 'red', 'on_white')
			all_open_positions_from_market.append(df)


	print(open_positions_ticket)
	...
	if(len(open_positions_ticket) > 0):
		...
		for position in open_positions_ticket:
			...
			all_open_positions.append(position[0]) # getting ticket data from tuple data type
